...
IMG ?= oauth2-redirect-controller:latest
...
manifests: controller-gen ## Generate WebhookConfiguration, ClusterRole and CustomResourceDefinition objects.
	...
	cp config/base/crd/bases/* chart/oauth2-redirect-controller/crds/
...
golangci-lint: ## Download golint locally if necessary
	$(call go-install-tool,$(GOLANGCI_LINT),github.com/golangci/golangci-lint/cmd/v2/golangci-lint@v2.1.2)
